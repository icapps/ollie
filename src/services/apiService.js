    ...
    return new Promise((resolve, reject) => {
      ...
      switch (this.gitService.name) {
        ...
        // TODO: create a repository under a new/existing team/project - replace bitbucketUserName with teamName for example
          path = `${urlObject.protocol}//${bitbucketUserName}:${bitbucketPassword}@${urlObject.host}${urlObject.pathname}/repositories/${bitbucketUserName}/${this.answers.name}`;
          remoteRepository = `${urlObject.protocol}//${bitbucketUserName}@bitbucket.org/${bitbucketUserName}/${this.answers.name}.git`;

...
var backendProject = _lodash2.default.find(_constants.projectTypes, { name: 'Backend' });
var frontendProject = _lodash2.default.find(_constants.projectTypes, { name: 'Frontend' });
...
var questions = {
  backend: {
    ...
    type: 'list',
    choices: _lodash2.default.map(backendProject.boilerPlates, 'name'),
    filter: function filter(answer) {
      return _lodash2.default.find(backendProject.boilerPlates, { name: answer });
    }
  },
  frontend: {
    name: 'boilerplate',
    ...
    type: 'list',
    choices: _lodash2.default.map(frontendProject.boilerPlates, 'name'),
    filter: function filter(answer) {
      return _lodash2.default.find(frontendProject.boilerPlates, { name: answer });
    }
  },
  ios: {
    name: 'boilerplate',

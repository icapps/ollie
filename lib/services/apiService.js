...
const ApiServiceError = (function (_Error) {
...
const ApiService = (function () {
    function ApiService(answers) {
        ...
        const urlObject = _url2.default.parse(answers.gitService.api);
        this.service = {
...
const GithubApiService = exports.GithubApiService = (function (_ApiService) {
...
const BitBucketApiService = exports.BitBucketApiService = (function (_ApiService2) {

...
var BaseSurvey = function () {
  function BaseSurvey() {
    _classCallCheck(this, BaseSurvey);

    this.answers = {};
  }

  _createClass(BaseSurvey, [{
    key: 'start',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var boilerplateDialog, boilerplateAnswers, cloneDialog, cloneAnswers, replaceVariablesDialog, git;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                boilerplateDialog = new _boilerplate2.default(this.type);
                _context.next = 3;
...
exports.default = BaseSurvey;
module.exports = exports['default'];
//# sourceMappingURL=base.survey.js.map
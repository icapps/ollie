...
const questions = [].concat(_boilerplate_questions.webBoilerplateQuestions, _general_questions2.default, _git_questions2.default);

const WebSurvey = (function (_SurveyTemplate) {
